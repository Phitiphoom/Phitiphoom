...
Here are some of the core systems I've architected and developed to drive operational efficiency:

| 🏭 Project | 📋 Description | 🛠️ Core Tech |
| :--- | :--- | :--- |
| **Dely PL Dashboard** | A dynamic production planning dashboard designed for real-time factory floor metrics and monitoring. | Next.js, Prisma, SQL Server |
| **IT-Helpdesk System** | A comprehensive technical support management platform streamlining internal operations and ticketing. | React, TypeScript, NextAuth |
| **HR & Doc Control** | A centralized hub for corporate document tracking and employee data visualization. | Next.js, Tailwind, .NET Print |
...
<p align="left">
  <strong>Backend, ORM & Databases</strong><br>
  <a href="https://skillicons.dev">
...
- 📈 **Analyzing Markets:** Focusing on high-growth tech and semiconductor trends (NVIDIA, ASML, Tesla, IONQ) with a target of retiring by 40 on dividend income.
- 🚗 **Exploring Automotive Tech:** Evaluating specs, insurance costs, and innovations in the latest EV and Hybrid vehicles (Deepal S05, Geely EX5, Volvo S90).
...
<!-- ต้องตั้งค่า GitHub Actions สำหรับ 3D Contrib ก่อน รูปตึก 3 มิติ ถึงจะแสดงผลนะครับ -->
